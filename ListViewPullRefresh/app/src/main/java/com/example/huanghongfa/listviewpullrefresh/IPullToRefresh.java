...
public interface IPullToRefresh<T extends View> {
     ...
     */
    public PullToRefreshAdapterViewBase.Mode getMode();
     ...
     */
    public void setMode(PullToRefreshAdapterViewBase.Mode mode);
     ...
     *                 propogate.
     */
    public void setOnPullEventListener(PullToRefreshAdapterViewBase.OnPullEventListener<T> listener);
     ...
     */
    public void setOnRefreshListener(PullToRefreshAdapterViewBase.OnRefreshListener<T> listener);
     ...
     * @param listener - Listener to be used when the Widget is set to Refresh
     */
    public void setOnRefreshListener(PullToRefreshAdapterViewBase.OnRefreshListener2<T> listener);
